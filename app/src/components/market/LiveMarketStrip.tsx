    ...
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="container max-w-7xl mx-auto px-6 mb-12">
        <div className="text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 glass-effect rounded-full text-blue-400 text-sm font-medium mb-6">
            <Activity className="w-4 h-4 animate-pulse" />
            Live Agent Market
          </div>
          <h2 className="text-3xl font-bold text-primary mb-4">Intelligence Trading Live</h2>
      ...
      <div className="relative">
        ...
        <div className="absolute left-0 top-0 w-32 h-full bg-gradient-to-r from-canvas to-transparent z-10" />
        <div className="absolute right-0 top-0 w-32 h-full bg-gradient-to-l from-canvas to-transparent z-10" />
        
        {/* Market cards container */}
        <div className="flex gap-6 pb-4 overflow-x-auto scrollbar-hide px-6">
          <div className="w-32 flex-shrink-0" /> {/* Left spacer */}
          
          {agents.map((agent) => (
            <div
              key={agent.id}
              className={`flex-shrink-0 w-80 glass-effect border border-subtle rounded-xl p-6 transition-all hover:bg-elevated agent-card-hover ${
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted text-sm">{agent.symbol}</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between mb-3">
                <div>
                  ...
                  <div className="text-muted text-sm">{agent.volume} 24h vol</div>
                </div>
