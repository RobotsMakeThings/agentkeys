"use strict";(()=>{var e={};e.id=4203,e.ids=[4203],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},53043:(e,t,s)=>{s.r(t),s.d(t,{originalPathname:()=>g,patchFetch:()=>m,requestAsyncStorage:()=>u,routeModule:()=>p,serverHooks:()=>_,staticGenerationAsyncStorage:()=>c});var i={};s.r(i),s.d(i,{GET:()=>d});var n=s(49303),r=s(88716),a=s(60670),o=s(1926),l=s(95456);async function d(e){let t=await (0,l.V8)(e);if(!t)return(0,l.m)();let{data:s,error:i}=await o.p.from("card_holdings").select(`
      *,
